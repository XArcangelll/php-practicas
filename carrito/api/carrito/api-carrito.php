...
function mostrar($carrito){
    ...
    foreach($itemsCarrito as $itemCarrito){
        $httpRequest = file_get_contents('http://localhost/curso/carrito/api/productos/api-productos.php?get-item=' . $itemCarrito['id']);
        //el ["item"] sirve para q esos elementos tengan ese valor del item mas no del status
