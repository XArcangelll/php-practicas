        ...
        <div id="user-container" class="container">
            <div id="user-header">
                <div id="user-info-container">
                    <div id="user-photo">
                        <img class="perfil" src="<?php if($user->getPhoto() == "") {echo constant('URL') ?>public/img/photos/user.png <?php }else{echo constant('URL') ?>public/img/photos/<?php echo $user->getPhoto();}?>" width="200">
                    </div>
                    <div id="user-info">
                        <h2><?php echo ($user->getName() == "") ? $user->getUsername() : $user->getName() ?></h2>
                    </div>
                </div>
            </div>
            <div id="side-menu">
                ...
                <section id="info-user-container">
                    <form action=<?php echo constant('URL'). 'user/updateName' ?> method="POST">
                        <div class="section">
                            ...
                            <input type="text" name="name" id="name" autocomplete="off" required value="<?php echo ($user->getName() == "") ? $user->getUsername() : $user->getName() ?>">
                    ...
                    <form action="<?php echo constant('URL'). 'user/updatePhoto' ?>" method="POST" enctype="multipart/form-data">
                        <div class="section">
                            <label for="photo">Foto de perfil</label>
                                ...
                                <img src="<?php if($user->getPhoto() == "") {echo constant('URL') ?>public/img/photos/user.png <?php }else{echo constant('URL') ?>public/img/photos/<?php echo $user->getPhoto();}?>" width="50" height="50" />
